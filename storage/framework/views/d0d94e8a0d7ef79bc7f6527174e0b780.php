...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="min-h-screen flex relative overflow-hidden" 
        x-data="{ 
            showPassword: false, 
            helpRequested: <?php echo e(session('status') ? 'true' : 'false'); ?>,
            isLoggingIn: false,
            mouseX: 0,
            mouseY: 0,
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-8">
                    ...
                    <div class="space-y-3 scale-in stagger-3">
                        ...
                        <div class="relative group input-focus-effect neon-border-pulse rounded-[24px]">
                            ...
                            <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username" class="w-full pl-14 pr-5 py-5 bg-slate-50 border-transparent rounded-[24px] text-sm font-bold outline-none transition-all shadow-inner focus:ring-0" placeholder="name@enterprise.com">
                        </div>
...
<?php endif; ?>
                    ...
                    <div class="space-y-3 scale-in stagger-4">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-[10px] font-black text-indigo-600 hover:text-indigo-800 uppercase tracking-widest transition-colors">
                                Identity Issues?
                            </a>
                        </div>
                        <div class="relative group input-focus-effect neon-border-pulse rounded-[24px]">
...
<?php endif; ?>
                ...
                <div class="pt-8 text-center">
                    <p class="text-[10px] text-slate-300 font-black uppercase tracking-[0.4em]">Node ID: RT-<?php echo e(substr(md5(now()), 0, 8)); ?> — SECURE</p>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/auth/login.blade.php ENDPATH**/ ?>