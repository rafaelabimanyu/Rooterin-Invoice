        ...
        <div class="w-full max-w-xl relative z-10 page-fade-in">
            <div class="bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[40px] p-10 md:p-16 shadow-2xl space-y-12">
                ...
                <div class="p-8 bg-white/5 border border-white/5 rounded-3xl space-y-8">
                    <div class="space-y-4">
                        <p class="text-slate-300 text-sm font-medium leading-relaxed text-center">
                            <?php echo e(__('SECURITY PROTOCOL: Automated password recovery is disabled. To maintain node integrity, all identity restorations must be performed manually.')); ?>
                    ...
                    <div class="pt-8 border-t border-white/5 space-y-6 text-center">
                        <p class="text-white text-base font-bold">
                            <?php echo e(__('To regain access to your node, please contact the System Administrator for manual identity verification at:')); ?>
                ...
                <div class="flex flex-col gap-6">
                    <a href="<?php echo e(route('login')); ?>" class="w-full py-6 bg-slate-900 text-white border border-white/10 rounded-[28px] font-black text-xs text-center shadow-xl hover:bg-white hover:text-slate-900 transition-all duration-500 uppercase tracking-[0.3em]">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>