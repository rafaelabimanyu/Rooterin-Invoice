<div class="space-y-6 animate-fade-in">
    <div class="p-5 bg-blue-600 rounded-2xl text-white shadow-xl shadow-blue-600/10 flex justify-between items-center">
        <div>
            <span class="px-2.5 py-0.5 bg-white/20 rounded-full text-[8px] font-black uppercase tracking-widest">{{ app()->getLocale() == 'en' ? 'Monthly Operational Feed' : 'Aliran Operasional Bulanan' }}</span>
                ...
                <div class="p-4 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between">
                    ...
                    <div class="text-right">
                        ...
                        <span class="px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-wider inline-block mt-1
                            ...
                            @elseif($inv->status == 'sent') bg-blue-50 text-blue-600
