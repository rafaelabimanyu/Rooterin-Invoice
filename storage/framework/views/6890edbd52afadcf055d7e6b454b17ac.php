        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto sm:ml-auto">
                ...
                >
                    ...
                    <span><?php echo e(__('+ Add Event / Reminder')); ?></span>
                </button>
            </div>
        </div>
    </div>
        ...
        >
            <div class="flex items-center gap-3 px-5 py-3.5 bg-white shadow-xl rounded-2xl border border-slate-100/80">
                ...
                <span class="text-[10px] font-black text-slate-600 uppercase tracking-widest">
                    <?php echo e(__('Syncing Calendar...')); ?>
        ...
        function chronosCalendar() {
            return {
                ...
                initCalendar() {
                    ...
                    this.calendar = new FullCalendar.Calendar(calendarEl, {
                        ...
                        events: (info, successCallback, failureCallback) => {
                            this.loading = true;
                            let url = '<?php echo e(route("chronos.events")); ?>';
                ...
                updateEventDate(event, oldEvent, revertFunc) {
                    ...
                    axios.post('<?php echo e(route("chronos.update-event")); ?>', {
                        id: id,
                        start: start,
                        end: end
                    })
                ...
                showTooltip(info) {
                    ...
                    let dateStr = info.event.start.toLocaleDateString('<?php echo e(app()->getLocale()); ?>', { day: 'numeric', month: 'short' });
                    if (info.event.end) {
                        let dispEnd = new Date(info.event.end);
                        dispEnd.setDate(dispEnd.getDate() - 1);
                        if (dispEnd > info.event.start) {
                            dateStr += ' - ' + dispEnd.toLocaleDateString('<?php echo e(app()->getLocale()); ?>', { day: 'numeric', month: 'short' });
                        }
                    }
...
<?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/chronos/components/calendar-grid.blade.php ENDPATH**/ ?>