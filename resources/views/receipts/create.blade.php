    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            <div class="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">
                ...
                <span class="text-slate-900">New Receipt</span>
            </div>
            <h1 class="text-2xl font-bold text-slate-900 font-outfit">Create Receipt</h1>
            <p class="text-sm text-slate-500">Generate a professional payment receipt for your client.</p>
        </div>
    </div>
