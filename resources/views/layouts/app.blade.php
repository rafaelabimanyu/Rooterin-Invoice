            ...
            >
                ...
                <header class="h-16 flex items-center justify-between px-6 md:px-10 bg-white/70 dark:bg-premium-900/70 backdrop-blur-2xl border-b border-slate-200/50 dark:border-white/[0.05] sticky top-0 z-50">
                    <div class="flex items-center gap-4 md:gap-8">
                        <!-- Toggle Button -->
                        <button @click="collapsed = !collapsed" class="hidden lg:flex p-2 text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 rounded-xl transition-all duration-300 group">
