        ...
        <div class="max-w-6xl mx-auto space-y-10">
            ...
            <div class="glass-card overflow-hidden">
                ...
                <div class="px-8 py-10 bg-slate-50/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-slate-100">
                    ...
                    <div class="w-12 h-12 rounded-2xl bg-gold-50 border border-gold-100 flex items-center justify-center text-gold-600 shadow-md">
                ...
                <div class="p-8 md:p-12">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="p-8 rounded-3xl bg-slate-50/50 hover:bg-white border border-slate-200/50 hover:border-slate-350 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-64 group relative overflow-hidden">
                            <div class="absolute -right-10 -top-10 w-28 h-28 bg-gold-500/5 blur-2xl group-hover:bg-gold-500/10 transition-colors duration-300 rounded-full"></div>
                            <div class="space-y-4">
                                <div class="w-12 h-12 rounded-xl bg-gold-50 border border-gold-100 flex items-center justify-center text-gold-600 transition-transform duration-500 group-hover:rotate-6">
                            ...
                            <a href="{{ route('guide.index') }}" class="inline-flex items-center gap-2 text-xs font-black text-gold-600 uppercase tracking-widest hover:text-gold-800 transition-colors mt-6">
