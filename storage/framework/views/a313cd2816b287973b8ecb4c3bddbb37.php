    ...
    <nav id="master-nav" class="fixed top-0 w-full z-[100] bg-[#0a0f1d]/80 backdrop-blur-3xl border-b border-white/5 initial-hidden fade-down">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-10">
                ...
                <a href="<?php echo e(route('login')); ?>" class="px-8 py-3 bg-white text-slate-900 rounded-2xl font-black text-[11px] shadow-2xl hover:bg-blue-50 transition-all uppercase tracking-[0.2em]">Portal Login</a>
            </div>
        ...
        <div x-show="mobileMenu" x-cloak class="fixed inset-0 bg-[#0a0f1d]/95 backdrop-blur-2xl z-[110] p-10 flex flex-col items-center justify-center text-center" 
            ...
            <div class="flex flex-col gap-12">
                ...
                <a href="<?php echo e(route('login')); ?>" class="px-10 py-5 bg-white text-slate-900 rounded-3xl font-black shadow-2xl uppercase tracking-widest text-sm">Portal Login</a>
            </div>
    ...
    <section class="relative min-h-[90vh] flex items-center justify-center pt-24 px-8 overflow-hidden">
        <div class="max-w-7xl mx-auto text-center relative z-10">
            ...
            <div id="hero-buttons" class="flex flex-col md:flex-row items-center justify-center gap-6 initial-hidden fade-up">
                <a href="<?php echo e(route('login')); ?>" class="w-full md:w-auto px-16 py-7 bg-white text-slate-900 rounded-[40px] font-black shadow-[0_20px_50px_rgba(255,255,255,0.1)] hover:-translate-y-2 transition-all duration-500 uppercase tracking-widest text-[13px]">Initialize Portal</a>
...
</html><?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/welcome.blade.php ENDPATH**/ ?>