<x-app-layout>
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-slate-900 font-outfit">Add New Client</h1>
        <p class="text-slate-500">Register a new customer for your business</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
                    ...
                    <x-input label="Client Code" name="kode_client" value="{{ $kode_client }}" readonly class="bg-slate-50 cursor-not-allowed" />

                    <div class="space-y-1.5">
                        <label class="block text-sm font-semibold text-slate-700">Status</label>
                        <select name="status" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all outline-none text-slate-900">
                ...
                <div class="p-6 bg-indigo-50 rounded-3xl border border-indigo-100">
                    <p class="text-sm text-indigo-700 font-medium mb-4">Make sure all information is correct before saving.</p>
