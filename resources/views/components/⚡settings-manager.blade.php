...
<div class="relative pb-24">
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <nav class="flex flex-col space-y-1">
                @foreach(['general' => 'Identity', 'finance' => 'Finance', 'localization' => 'Regional', 'notifications' => 'Communications', 'appearance' => 'Branding', 'security' => 'Security'] as $tab => $label)
                    <button 
                        ...
                        class="flex items-center gap-3 px-5 py-4 rounded-2xl text-[13px] font-black uppercase tracking-widest transition-all duration-300
        ...
        <div class="lg:col-span-3 space-y-8">
            <div class="glass-card p-10 min-h-[600px]">
                <!-- General Tab -->
                <div x-show="$wire.activeTab === 'general'" x-transition:enter="fade-in">
                ...
                <!-- Finance Tab -->
                <div x-show="$wire.activeTab === 'finance'" x-cloak x-transition:enter="fade-in">
                    <div class="flex items-center gap-4 mb-10 pb-6 border-b border-slate-100">
                ...
                <!-- Appearance Tab -->
                <div x-show="$wire.activeTab === 'appearance'" x-cloak x-transition:enter="fade-in">
                    <div class="flex items-center gap-4 mb-10 pb-6 border-b border-slate-100">
                ...
                <!-- Localization Tab -->
                <div x-show="$wire.activeTab === 'localization'" x-cloak x-transition:enter="fade-in">
                    <div class="flex items-center gap-4 mb-10 pb-6 border-b border-slate-100">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-3">
                                    <button class="flex-1 py-4 rounded-2xl border-2 transition-all font-black uppercase text-[11px] tracking-widest {{ ($settings['language'] ?? 'id') === 'id' ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-transparent bg-slate-50 text-slate-400' }}" @click="$wire.set('settings.language', 'id')">Bahasa Indonesia</button>
                                    <button class="flex-1 py-4 rounded-2xl border-2 transition-all font-black uppercase text-[11px] tracking-widest {{ ($settings['language'] ?? 'id') === 'en' ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-transparent bg-slate-50 text-slate-400' }}" @click="$wire.set('settings.language', 'en')">English (Global)</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Notifications Tab -->
                <div x-show="$wire.activeTab === 'notifications'" x-cloak x-transition:enter="fade-in">
                    <div class="flex items-center gap-4 mb-10 pb-6 border-b border-slate-100">
                ...
                <!-- Security Tab -->
                <div x-show="$wire.activeTab === 'security'" x-cloak x-transition:enter="fade-in">
                    <div class="flex items-center gap-4 mb-10 pb-6 border-b border-slate-100">
    ...
    >
        ...
        <div class="flex items-center gap-3">
            <button @click="$wire.discard()" class="px-6 py-3 text-[11px] font-black text-slate-400 uppercase tracking-widest hover:text-white transition-colors">Discard</button>
            <button @click="$wire.save()" class="px-8 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-[11px] font-black uppercase tracking-widest transition-all shadow-xl shadow-indigo-600/20">Apply Changes</button>
        </div>
    </div>
</div>