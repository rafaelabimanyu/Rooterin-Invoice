        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-3 md:gap-6">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-tight text-center sm:text-left">
                    &copy; {{ date('Y') }} <span class="text-slate-700">Rooterin System Operational.</span> <span class="hidden md:inline">All rights reserved.</span>
                </p>
            ...
            <div class="flex items-center gap-6 sm:gap-8 md:gap-10">
                <a href="{{ route('privacy.index') }}" class="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-colors duration-200">Privacy</a>
                <a href="{{ route('terms.index') }}" class="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-colors duration-200">Terms</a>
                <a href="{{ route('help.index') }}" class="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-colors duration-200">Help Center</a>
            </div>
        </div>
    </div>
</footer>
