<aside class="hidden lg:block lg:w-64 lg:sticky lg:top-24 lg:h-[calc(100vh-120px)] overflow-y-auto border-r border-slate-100 lg:pr-6">
    <nav class="space-y-1 pb-8 lg:pb-0">
