<div class="mb-14 p-6 lg:p-8 glass-card rounded-3xl border border-slate-100 bg-white/50">
    ...
    <div class="relative flex flex-col md:flex-row items-start md:items-center justify-between w-full mt-4 space-y-6 md:space-y-0">
        <!-- Desktop Horizontal Line -->
        <div class="hidden md:block absolute left-8 right-8 top-5 -translate-y-1/2 h-0.5 bg-slate-200 -z-10"></div>
        
        <!-- Mobile Vertical Line -->
        <div class="md:hidden absolute top-5 bottom-5 left-5 -translate-x-1/2 w-0.5 bg-slate-200 -z-10"></div>
        ...
        <div class="flex flex-row md:flex-col items-center group relative cursor-pointer w-full md:w-1/4">
            ...
            <div class="hidden md:block absolute -top-12 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-slate-900 text-white text-xs font-semibold py-1.5 px-3 rounded-lg shadow-xl whitespace-nowrap pointer-events-none translate-y-2 group-hover:translate-y-0">
                {{ __($step['step']) }}
