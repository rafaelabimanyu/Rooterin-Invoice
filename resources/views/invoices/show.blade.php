    ...
    <div class="bg-white rounded-[24px] md:rounded-[32px] border border-slate-200/60 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] overflow-hidden max-w-5xl mx-auto mb-20 relative w-full">
        ...
        <div class="px-6 md:px-16 py-8 bg-slate-50/50 border-t border-slate-100">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-[10px] font-black text-gold-600 bg-gold-50 px-2.5 py-1 rounded-full border border-gold-100">{{ $invoice->attachments->count() }} {{ app()->getLocale() == 'en' ? 'Photos' : 'Foto' }}</span>
            </div>
