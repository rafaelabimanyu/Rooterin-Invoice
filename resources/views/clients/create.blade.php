<x-app-layout :title="app()->getLocale() == 'en' ? 'Client & Partner Management' : 'Manajemen Klien & Mitra'">
    <div class="mb-8">
        <a href="{{ route('clients.index') }}" class="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-gold-600 transition-colors mb-4 font-jakarta font-bold">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-sm space-y-6">
                    <h3 class="text-sm font-black text-slate-900 uppercase tracking-widest mb-4 flex items-center gap-2 font-outfit">
                        <i data-lucide="user" class="w-4 h-4 text-gold-600"></i>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <x-input label="{{ app()->getLocale() == 'en' ? 'Company Name' : 'Nama Perusahaan' }}" name="nama_perusahaan" placeholder="e.g. J&J GROUP Co." />
                    </div>
                    ...
                    <div x-data="{ clientType: '{{ old('client_type', 'individual') }}', industrySector: '{{ old('industry_sector', 'general') }}' }" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-1.5">
                                ...
                                <select name="client_type" x-model="clientType" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all outline-none text-slate-900 font-bold text-sm">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <select name="industry_sector" x-model="industrySector" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all outline-none text-slate-900 font-bold text-sm">
                ...
                <div class="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-sm space-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="alamat" rows="3" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all outline-none text-slate-900">{{ old('alamat') }}</textarea>
                    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-sm space-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <select name="status" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all outline-none text-slate-900 font-bold text-sm">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="catatan" rows="4" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all outline-none text-slate-900">{{ old('catatan') }}</textarea>
                    </div>
                </div>

                <div class="p-6 bg-gold-50 rounded-3xl border border-gold-100">
                    <p class="text-xs text-gold-700 font-bold mb-4 font-jakarta uppercase tracking-wider">{{ app()->getLocale() == 'en' ? 'Make sure all information is correct before saving.' : 'Pastikan semua informasi sudah benar sebelum disimpan.' }}</p>
