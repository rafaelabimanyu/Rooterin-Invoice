...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white rounded-3xl overflow-hidden shadow-2xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto border border-slate-200"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/components/modal.blade.php ENDPATH**/ ?>