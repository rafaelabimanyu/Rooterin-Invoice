    ...
    <div>
        <div class="flex items-center justify-between mb-4">
            <h3 class="font-black text-slate-900 font-jakarta uppercase tracking-tight text-xs">
                <?php echo e(app()->getLocale() == 'en' ? 'System Analytics' : 'Analitik Sistem'); ?>
        ...
        <div class="p-4 bg-slate-50 rounded-xl border border-slate-100/60 mt-4">
            <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">
                <?php echo e(app()->getLocale() == 'en' ? 'Operational Load' : 'Beban Operasional'); ?>

            </p>
            <div class="flex items-end gap-2 mb-3">
                <span class="text-xl font-black text-slate-900 leading-none">
                    <?php echo e(app()->getLocale() == 'en' ? 'Efficient' : 'Optimal'); ?>
...
<?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/dashboard/partials/system-analytics.blade.php ENDPATH**/ ?>