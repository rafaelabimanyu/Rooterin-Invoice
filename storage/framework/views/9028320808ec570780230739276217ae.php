...
<div class="glass-card p-6 border-slate-100 shadow-2xl shadow-rose-500/5 page-fade-in stagger-2 bg-white/80 backdrop-blur-md rounded-3xl">
    <h3 class="font-black text-slate-900 font-jakarta uppercase tracking-tight text-md mb-6">
        <?php echo e(__('Metrics Insights')); ?>
    ...
    <div class="space-y-6">
        <div>
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">
                <?php echo e(__('Total Active Arrears')); ?>

            </p>
            <h4 class="text-2xl font-black text-rose-500 font-jakarta tracking-tighter">
                Rp <?php echo e(number_format($activeArrears, 0, ',', '.')); ?>
        ...
        <div class="pt-6 border-t border-slate-50">
            ...
            <div class="flex items-center gap-3">
                ...
                <h4 class="text-2xl font-black text-slate-900 font-jakarta tracking-tighter">
                    <?php echo e($dueThisWeek); ?> <span class="text-sm text-slate-400 font-medium tracking-normal"><?php echo e(__('Invoices')); ?></span>
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="relative pl-8">
                    ...
                    <div class="space-y-1">
                        <p class="text-[12px] font-bold text-slate-800 leading-snug"><?php echo e($activity->description); ?></p>
                        <p class="text-[10px] text-slate-400 font-medium"><?php echo e($activity->created_at->diffForHumans()); ?> - <?php echo e($activity->user->name); ?></p>
                    </div>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <div class="text-center py-8">
                    ...
                    <p class="text-[11px] font-bold text-slate-900 uppercase tracking-widest">
                        <?php echo e(__('No activities yet')); ?>
...
<?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/chronos/components/sidebar-metrics.blade.php ENDPATH**/ ?>