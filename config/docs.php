...
return [
    /*
    |--------------------------------------------------------------------------
    | J&J GROUP Documentation & Role-Based Access Control (RBAC) Config
    |--------------------------------------------------------------------------
    |
    | File ini menyimpan struktur menu, workflow, dan konten dokumentasi
    | yang dipisahkan berdasarkan Role: Owner, Admin, dan Staff.
    | Anda dapat menggunakan nested array untuk membuat sub-section.
    |
    */
    ...
    'roles' => [
        ...
        /*
        |--------------------------------------------------------------------------
        | LEVEL: STAFF (Daily Execution & Task-Oriented)
        |--------------------------------------------------------------------------
        ...
        */
        'staff' => [
            ...
            'workflow' => [
                ['label' => 'Input Client', 'step' => 'Step 1', 'desc' => 'Registrasi NPWP & Data'],
                ['label' => 'Quotation', 'step' => 'Step 2', 'desc' => 'Penawaran Harga'],
                ['label' => 'Invoice', 'step' => 'Step 3', 'desc' => 'Rilis Tagihan'],
                ['label' => 'Paid', 'step' => 'Step 4', 'desc' => 'Catat Pembayaran'],
            ],
            'navigation' => [
                'getting-started' => [
        ...
        /*
        |--------------------------------------------------------------------------
        | LEVEL: ADMIN (System Management & Operational Oversight)
        |--------------------------------------------------------------------------
        | Focus: User Management & Data Integrity.
        */
        'admin' => [
            'header' => [
            ...
            'workflow' => [
                ...
                ['label' => 'Manage Users', 'step' => 'Step 3', 'desc' => 'Akses Kontrol'],
        ...
        /*
        |--------------------------------------------------------------------------
        | LEVEL: OWNER (High-Level Strategy & Full Control)
        |--------------------------------------------------------------------------
        | Focus: Profitability, KPI Monitoring, & Legalitas.
        */
        'owner' => [
            'header' => [
