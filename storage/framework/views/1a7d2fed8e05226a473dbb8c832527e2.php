<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($minimal): ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-12 animate-fade-in-up">
            ...
            <div class="glass-card p-6 group hover:-translate-y-1 hover:shadow-lg hover:border-amber-500/20 transition-all duration-300 ease-out cursor-pointer relative overflow-hidden border border-slate-200/50"
                ...
                <div class="flex items-center justify-between mb-6 relative z-10">
                    ...
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black bg-amber-50 text-amber-600 shadow-sm">
                        <?php echo e(app()->getLocale() == 'en' ? 'Receivable' : 'Piutang'); ?>

                    </span>
                </div>
                <div class="relative z-10">
                    <p class="text-[10px] md:text-[11px] font-black text-slate-500 uppercase tracking-[0.25em] mb-2">
                        <?php echo e(__('ui.amount_due')); ?>
            ...
            <div class="glass-card p-6 group hover:-translate-y-1 hover:shadow-lg hover:border-emerald-500/20 transition-all duration-300 ease-out cursor-pointer relative overflow-hidden border border-slate-200/50"
                ...
                <div class="flex items-center justify-between mb-6 relative z-10">
                    ...
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black bg-emerald-50 text-emerald-600 shadow-sm">
                        <?php echo e(app()->getLocale() == 'en' ? 'Active' : 'Aktif'); ?>

                    </span>
                </div>
                <div class="relative z-10">
                    <p class="text-[10px] md:text-[11px] font-black text-slate-500 uppercase tracking-[0.25em] mb-2">
                        <?php echo e(__('ui.clients')); ?>

                    </p>
                    <h3 class="text-xl sm:text-2xl lg:text-lg xl:text-xl 2xl:text-2xl font-black text-slate-900 font-jakarta tracking-tight group-hover:translate-x-1 transition-transform duration-500 truncate">
                        <?php echo e($totalClientsCount); ?>
            ...
            <div class="glass-card p-6 group hover:-translate-y-1 hover:shadow-lg hover:border-indigo-500/20 transition-all duration-300 ease-out cursor-pointer relative overflow-hidden border border-slate-200/50"
                ...
                <div class="flex items-center justify-between mb-6 relative z-10">
                    ...
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black bg-indigo-50 text-indigo-600 shadow-sm">
                        <?php echo e(__('ui.efficiency')); ?>

                    </span>
                </div>
                <div class="relative z-10">
                    <p class="text-[10px] md:text-[11px] font-black text-slate-500 uppercase tracking-[0.25em] mb-2">
                        <?php echo e(__('ui.collection_rate')); ?>

                    </p>
                    <h3 class="text-xl sm:text-2xl lg:text-lg xl:text-xl 2xl:text-2xl font-black text-slate-900 font-jakarta tracking-tight group-hover:translate-x-1 transition-transform duration-500 truncate">
                        <?php echo e(round($collectionRate)); ?>%
                    </h3>
        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6 page-fade-in">
            <div>
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-black text-slate-900 font-jakarta tracking-tight uppercase"><?php echo e(app()->getLocale() == 'en' ? 'Executive Intelligence' : 'Kecerdasan Eksekutif'); ?></h1>
                        <p class="text-[11px] text-slate-500 font-bold uppercase tracking-[0.1em]"><?php echo e(app()->getLocale() == 'en' ? 'Business performance & growth analytics' : 'Analisis kinerja bisnis & pertumbuhan'); ?></p>
                    </div>
                </div>
            </div>
            <div class="hidden md:flex items-center gap-4">
                <div class="px-4 py-2 glass-panel rounded-xl shadow-sm flex items-center gap-3 border-slate-200/50">
                    <div class="flex flex-col">
                        <span class="text-[8px] font-black text-slate-400 uppercase tracking-widest leading-none"><?php echo e(app()->getLocale() == 'en' ? 'Telemetry' : 'Telemetri'); ?></span>
                        <div class="flex items-center gap-1.5 mt-1">
                            <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                            <span class="text-[10px] font-bold text-slate-700 uppercase"><?php echo e(app()->getLocale() == 'en' ? 'Live Feed' : 'Aktivitas Terkini'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-4 no-scrollbar md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-4 lg:gap-6 md:pb-0 md:overflow-x-visible mb-8 page-fade-in" style="animation-delay: 100ms">
            ...
            <div class="glass-card p-6 group hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 relative overflow-hidden border-indigo-500/10 cursor-pointer min-w-[85%] snap-center md:min-w-0"
                ...
                <div class="flex items-center justify-between mb-6">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]"><?php echo e(app()->getLocale() == 'en' ? 'Revenue (MTD)' : 'Pendapatan (Bulan Berjalan)'); ?></p>
                    <div class="p-2.5 bg-indigo-50 rounded-xl text-indigo-600 group-hover:rotate-12 transition-transform duration-500">
                        <i data-lucide="banknote" class="w-5 h-5"></i>
                    </div>
                </div>
                <h3 class="text-xl sm:text-2xl lg:text-lg xl:text-xl 2xl:text-2xl font-black text-slate-900 font-jakarta tracking-tight mb-4 truncate">Rp <?php echo e(number_format($currentMonthRevenue, 0, ',', '.')); ?></h3>
                <div class="pt-4 border-t border-slate-50 flex items-center justify-between">
                    <span class="text-[9px] text-slate-400 font-black uppercase tracking-widest"><?php echo e(app()->getLocale() == 'en' ? 'Growth' : 'Pertumbuhan'); ?></span>
                    <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-black <?php echo e($revenueChange >= 0 ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'); ?>">
                        <i data-lucide="<?php echo e($revenueChange >= 0 ? 'trending-up' : 'trending-down'); ?>" class="w-3 h-3"></i>
            ...
            <div class="glass-card p-6 group hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 relative overflow-hidden border-amber-500/10 cursor-pointer min-w-[85%] snap-center md:min-w-0"
                 ...
                 wire:click="openModal('risks')">
                <div class="flex items-center justify-between mb-6">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]"><?php echo e(app()->getLocale() == 'en' ? 'Capital at Risk' : 'Modal dalam Risiko'); ?></p>
                    <div class="p-2.5 bg-amber-50 rounded-xl text-amber-600 group-hover:rotate-12 transition-transform duration-500">
                        <i data-lucide="alert-triangle" class="w-5 h-5"></i>
                    </div>
                </div>
                <h3 class="text-xl sm:text-2xl lg:text-lg xl:text-xl 2xl:text-2xl font-black text-amber-600 font-jakarta tracking-tight mb-4 truncate">Rp <?php echo e(number_format($totalUnpaid, 0, ',', '.')); ?></h3>
                <div class="pt-4 border-t border-slate-50 grid grid-cols-2 gap-4">
                    <div class="flex flex-col">
                        <span class="text-[8px] text-slate-400 font-black uppercase tracking-widest"><?php echo e(app()->getLocale() == 'en' ? 'Floating' : 'Berjalan'); ?></span>
                        <span class="text-[11px] font-black text-slate-700">Rp <?php echo e(number_format($pendingUnpaid, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex flex-col text-right">
                        <span class="text-[8px] text-rose-400 font-black uppercase tracking-widest"><?php echo e(app()->getLocale() == 'en' ? 'Critical' : 'Kritis'); ?></span>
                        <span class="text-[11px] font-black text-rose-600">Rp <?php echo e(number_format($overdueUnpaid, 0, ',', '.')); ?></span>
                    </div>
                </div>
                <div class="absolute inset-0 shimmer opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
            </div>
            ...
            <div class="glass-card p-6 group hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 relative overflow-hidden border-emerald-500/10 cursor-pointer min-w-[85%] snap-center md:min-w-0"
                 ...
                 wire:click="openModal('loyalty')">
                <div class="flex items-center justify-between mb-6">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]"><?php echo e(app()->getLocale() == 'en' ? 'Loyalty Pulse' : 'Indeks Loyalitas'); ?></p>
                ...
                <h3 class="text-xl sm:text-2xl lg:text-lg xl:text-xl 2xl:text-2xl font-black text-slate-900 font-jakarta tracking-tight mb-4 truncate"><?php echo e(number_format($repeatRate, 1)); ?>%</h3>
                <div class="space-y-2.5 relative z-10">
                    <div class="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                        <div class="bg-emerald-500 h-full shadow-[0_0_8px_rgba(16,185,129,0.5)]" style="width: <?php echo e($repeatRate); ?>%"></div>
                    </div>
                    <p class="text-[9px] text-slate-400 font-bold uppercase tracking-wider"><?php echo e(app()->getLocale() == 'en' ? 'Across ' : 'Dari '); ?><?php echo e($totalClients); ?><?php echo e(app()->getLocale() == 'en' ? ' entities' : ' entitas'); ?></p>
                </div>
                <div class="absolute inset-0 shimmer opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
            </div>
            ...
            <div class="glass-card p-6 group hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 relative overflow-hidden border-rose-500/10 cursor-pointer min-w-[85%] snap-center md:min-w-0"
                ...
                <div class="flex items-center justify-between mb-6">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]"><?php echo e(app()->getLocale() == 'en' ? 'Prime Asset' : 'Aset Utama'); ?></p>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($topClients->count() > 0): ?>
                    <h3 class="text-base sm:text-lg lg:text-sm xl:text-base 2xl:text-lg font-black text-slate-900 font-jakarta tracking-tight truncate mb-0.5"><?php echo e($topClients[0]->nama_client); ?></h3>
                    <p class="text-[10px] text-slate-500 font-bold uppercase tracking-wider truncate"><?php echo e($topClients[0]->nama_perusahaan); ?></p>
                    <div class="mt-6 pt-4 border-t border-slate-50 flex items-center justify-between">
                        <span class="text-[9px] text-slate-400 font-black uppercase tracking-widest"><?php echo e(app()->getLocale() == 'en' ? 'Valuation' : 'Valuasi'); ?></span>
                        <span class="text-[12px] font-black text-slate-900 tracking-tighter">Rp <?php echo e(number_format($topClients[0]->invoices_sum_total, 0, ',', '.')); ?></span>
                    </div>
                <?php else: ?>
                    <p class="text-[10px] text-slate-400 italic font-medium"><?php echo e(app()->getLocale() == 'en' ? 'Insufficient data' : 'Data tidak mencukupi'); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 page-fade-in" style="animation-delay: 200ms">
            ...
            <div class="lg:col-span-2 glass-card p-8">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h3 class="font-black text-slate-900 font-jakarta uppercase tracking-tight text-lg"><?php echo e(app()->getLocale() == 'en' ? 'Revenue Vectors' : 'Vektor Pendapatan'); ?></h3>
                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-[0.15em] mt-1"><?php echo e(app()->getLocale() == 'en' ? '6-Month historical analysis' : 'Analisis riwayat 6 bulan'); ?></p>
                    </div>
                    <div class="hidden sm:flex items-center gap-3">
                        <div class="flex items-center gap-2 px-3 py-1 bg-indigo-50 rounded-full text-[9px] font-black text-indigo-600 uppercase tracking-widest">
                            ...
                            <?php echo e(app()->getLocale() == 'en' ? 'Gross Intake' : 'Pemasukan Kotor'); ?>
            ...
            <div class="glass-card overflow-hidden flex flex-col group">
                <div class="p-6 border-b border-slate-100 bg-slate-50/30">
                    <h3 class="font-black text-slate-900 font-jakarta uppercase tracking-tight text-lg"><?php echo e(app()->getLocale() == 'en' ? 'Operational Summary' : 'Ringkasan Operasional'); ?></h3>
                    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-[0.15em] mt-1"><?php echo e(app()->getLocale() == 'en' ? 'Status' : 'Status'); ?>: <?php echo e(now()->format('M Y')); ?></p>
                </div>
                <div class="flex-1 p-6 flex flex-col justify-center space-y-6 relative">
                    <div class="flex items-center justify-between group/item cursor-pointer hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.15em] mb-0.5"><?php echo e(app()->getLocale() == 'en' ? 'New Issuance' : 'Penerbitan Baru'); ?></p>
                                <p class="text-xl font-black text-slate-900 font-jakarta"><?php echo e($monthlyPerformance['created']); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between group/item cursor-pointer hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.15em] mb-0.5"><?php echo e(app()->getLocale() == 'en' ? 'Settled Assets' : 'Aset Diselesaikan'); ?></p>
                                <p class="text-xl font-black text-slate-900 font-jakarta"><?php echo e($monthlyPerformance['paid']); ?></p>
                            </div>
                        </div>
                        <i data-lucide="chevron-right" class="w-4 h-4 text-slate-300 opacity-0 group-hover/item:opacity-100 transition-opacity"></i>
                    </div>
                    ...
                    <div class="flex items-center justify-between group/item cursor-pointer hover:translate-x-1 transition-transform"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.15em] mb-0.5"><?php echo e(app()->getLocale() == 'en' ? 'Stagnant Flow' : 'Aliran Stagnan'); ?></p>
                                <p class="text-xl font-black text-slate-900 font-jakarta"><?php echo e($monthlyPerformance['overdue']); ?></p>
                            </div>
                        </div>
                        <i data-lucide="chevron-right" class="w-4 h-4 text-slate-300 opacity-0 group-hover/item:opacity-100 transition-opacity"></i>
                    </div>
                    ...
                    <div class="pt-6 border-t border-slate-100">
                        <div class="flex items-center justify-between text-[10px] font-black uppercase tracking-widest mb-2">
                            <span class="text-slate-500"><?php echo e(app()->getLocale() == 'en' ? 'Collection Velocity' : 'Kecepatan Pengumpulan'); ?></span>
                            <span class="text-indigo-600"><?php echo e($monthlyPerformance['created'] > 0 ? round(($monthlyPerformance['paid'] / $monthlyPerformance['created']) * 100) : 0); ?>%</span>
                        </div>
                        <div class="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                            <div class="bg-indigo-600 h-full" style="width: <?php echo e($monthlyPerformance['created'] > 0 ? ($monthlyPerformance['paid'] / $monthlyPerformance['created']) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8 page-fade-in" style="animation-delay: 300ms">
            ...
            <div class="table-container">
                <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/30">
                    <div>
                        <h3 class="font-black text-slate-900 font-jakarta uppercase tracking-tight text-lg"><?php echo e(app()->getLocale() == 'en' ? 'Priority Entities' : 'Entitas Prioritas'); ?></h3>
                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1"><?php echo e(app()->getLocale() == 'en' ? 'Enterprise valuation (LTV)' : 'Valuasi perusahaan (LTV)'); ?></p>
                    </div>
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="table-header">
                                <th class="px-8 py-4 text-[10px]"><?php echo e(app()->getLocale() == 'en' ? 'Rank & Identity' : 'Peringkat & Identitas'); ?></th>
                                <th class="hidden sm:table-cell px-8 py-4 text-[10px]"><?php echo e(app()->getLocale() == 'en' ? 'Volume' : 'Volume'); ?></th>
                                <th class="hidden md:table-cell px-8 py-4 text-[10px] text-right"><?php echo e(app()->getLocale() == 'en' ? 'Valuation' : 'Valuasi'); ?></th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-50">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="table-row-premium cursor-pointer group"
                                    @click="$dispatch('slide-over-loading-start')"
                                    wire:click="openModal('client', <?php echo e($client->id); ?>)">
                                    <td class="px-8 py-4">
                                        <div class="flex items-center gap-4">
                                            <span class="w-7 h-7 rounded-lg bg-slate-900 flex items-center justify-center text-[9px] font-black text-white shrink-0"><?php echo e($index + 1); ?></span>
                                            <div class="flex flex-col max-w-[140px] sm:max-w-none">
                                                <span class="text-[13px] font-black text-slate-900 tracking-tight group-hover:text-indigo-600 transition-colors truncate"><?php echo e($client->nama_client); ?></span>
                                                <span class="text-[9px] text-slate-400 font-bold uppercase tracking-widest truncate"><?php echo e($client->nama_perusahaan); ?></span>
                                                <span class="md:hidden text-[11px] font-bold text-slate-900 tracking-tight mt-1">
                                                    Rp <?php echo e(number_format($client->invoices_sum_total, 0, ',', '.')); ?>
                                    ...
                                    <td class="hidden sm:table-cell px-8 py-4">
                                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 rounded-full text-[10px] font-bold text-slate-600">
                                            ...
                                            <?php echo e($client->invoices_count); ?> Unit
                                        </div>
                                    </td>
                                    <td class="hidden md:table-cell px-8 py-4 text-right">
                                        <span class="text-[13px] font-black text-slate-900 tracking-tighter">Rp <?php echo e(number_format($client->invoices_sum_total, 0, ',', '.')); ?></span>
                                    </td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <tr>
                                    <td colspan="3" class="px-8 py-12 text-center text-slate-400 italic text-sm">
                                        <?php echo e(app()->getLocale() == 'en' ? 'No data available' : 'Tidak ada data tersedia'); ?>
            ...
            <div class="glass-card flex flex-col">
                <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/30">
                    <div>
                        <h3 class="font-black text-slate-900 font-jakarta uppercase tracking-tight text-lg"><?php echo e(app()->getLocale() == 'en' ? 'Inflow Telemetry' : 'Telemetri Aliran Masuk'); ?></h3>
                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1"><?php echo e(app()->getLocale() == 'en' ? 'Major capital movements' : 'Pergerakan modal besar'); ?></p>
                    </div>
                ...
                <div class="p-4">
                    <div class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentLargePayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex items-center justify-between p-4 rounded-xl bg-slate-50/50 hover:bg-white hover:shadow-xl hover:-translate-x-1 transition-all duration-300 border border-transparent hover:border-slate-200/50 group cursor-pointer"
                                 @click="$dispatch('slide-over-loading-start')"
                                 wire:click="openModal('payment', <?php echo e($payment->id); ?>)">
                                <div class="flex items-center gap-4">
                                    <div class="w-11 h-11 rounded-xl bg-white flex flex-col items-center justify-center border border-slate-100 shadow-sm group-hover:bg-slate-900 transition-colors duration-500">
                                        <span class="text-[8px] font-black text-slate-400 uppercase leading-none group-hover:text-slate-500"><?php echo e($payment->payment_date->format('M')); ?></span>
                                        <span class="text-sm font-black text-slate-900 leading-none mt-0.5 group-hover:text-white"><?php echo e($payment->payment_date->format('d')); ?></span>
                                    </div>
                                    <div class="flex flex-col max-w-[120px] xs:max-w-[150px] sm:max-w-none">
                                        <span class="text-[13px] font-black text-slate-900 tracking-tight group-hover:text-indigo-600 transition-colors truncate"><?php echo e($payment->invoice?->client?->nama_client ?? 'N/A'); ?></span>
                                        <div class="flex items-center gap-1.5 mt-0.5 truncate">
                                            <span class="text-[9px] text-slate-400 font-bold uppercase tracking-widest truncate"><?php echo e($payment->invoice?->invoice_number ?? 'N/A'); ?></span>
                                            <span class="w-0.5 h-0.5 rounded-full bg-slate-300 shrink-0"></span>
                                            <span class="text-[9px] text-slate-400 font-bold uppercase tracking-widest truncate"><?php echo e($payment->payment_method); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col text-right">
                                    <span class="text-[14px] font-black text-emerald-600 tracking-tighter">Rp <?php echo e(number_format($payment->amount, 0, ',', '.')); ?></span>
                                    <span class="text-[8px] text-slate-400 font-black uppercase tracking-widest mt-0.5"><?php echo e(app()->getLocale() == 'en' ? 'Inflow' : 'Masuk'); ?></span>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <div class="py-12 text-center text-slate-400 italic text-sm">
                                <?php echo e(app()->getLocale() == 'en' ? 'No recent inflows' : 'Tidak ada aliran masuk baru'); ?>
        ...
        <script>
            (function() {
                window.initChart = function() {
                    ...
                    const categories = <?php echo json_encode($revenueTrend->pluck('month')); ?>;
                    const data = <?php echo json_encode($revenueTrend->pluck('revenue')); ?>;
                    ...
                    const options = {
                        series: [{
                            name: '<?php echo e(app()->getLocale() == 'en' ? "Enterprise Revenue" : "Pendapatan Perusahaan"); ?>',
                            data: data
                        }],
                        chart: {
                            type: 'area',
...
<?php /**PATH C:\laragon\www\Rooterin-Invoice\resources\views/livewire/owner-kpi.blade.php ENDPATH**/ ?>