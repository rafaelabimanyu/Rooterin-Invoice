<x-app-layout>
    <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            ...
            <h1 class="text-2xl font-bold text-slate-900 font-outfit">Team Management</h1>
            <p class="text-sm text-slate-500">Configure roles and access permissions for your staff.</p>
        </div>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="text-[10px] font-bold uppercase tracking-[0.1em] text-slate-400 bg-slate-50/50">
                        <th class="px-8 py-4 border-b border-slate-100">User Details</th>
                        <th class="px-8 py-4 border-b border-slate-100">Assigned Role</th>
                        <th class="px-8 py-4 border-b border-slate-100">Joined Date</th>
                            ...
                            <td class="px-8 py-4.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-[13px] font-bold text-slate-900">{{ $user->name }}</span>
