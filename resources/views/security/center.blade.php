<x-app-layout :title="app()->getLocale() == 'en' ? 'Security Command Center' : 'Pusat Kontrol Keamanan'">
    <div class="animate-fade-in-up">
        <div class="mb-10">
            <div class="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">
                ...
                <span class="text-gold-600">{{ app()->getLocale() == 'en' ? 'Security Command Center' : 'Pusat Kontrol Keamanan' }}</span>
            </div>
