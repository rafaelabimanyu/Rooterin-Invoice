<x-app-layout>
    <div class="mb-10">
        ...
        <h1 class="text-2xl font-bold text-slate-900 font-outfit">Add New Team Member</h1>
        <p class="text-sm text-slate-500">Register a new staff member and assign their role.</p>
    </div>
